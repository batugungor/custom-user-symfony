...
/**
 * TblCompaniesNewslettersTemplates
 *
 * @ORM\Table(name="tbl_companies_newsletters_templates")
 * @ORM\Entity
 */
class TblCompaniesNewslettersTemplates
{
    /**
     * @var int
     *
     * @ORM\Column(name="tbl_companies_newsletters_templates_id", type="integer", nullable=false)
     * @ORM\Id
