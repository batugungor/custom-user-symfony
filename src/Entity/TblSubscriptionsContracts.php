...
/**
 * TblSubscriptionsContracts
 *
 * @ORM\Table(name="tbl_subscriptions_contracts")
 * @ORM\Entity
 */
class TblSubscriptionsContracts
{
    /**
     * @var int
     *
     * @ORM\Column(name="tbl_subscriptions_contracts_id", type="integer", nullable=false)
     * @ORM\Id
     ...
     * @var int|null
     *
     * @ORM\Column(name="tbl_subscriptions_discounts_id", type="integer", nullable=true)
     */
    ...
    public function setTblSubscriptionsDiscountsId(?int $tblSubscriptionsDiscountsId): self
    {
        $this->tblSubscriptionsDiscountsId = $tblSubscriptionsDiscountsId;
