...
/**
 * TblCompaniesServicesReminders
 *
 * @ORM\Table(name="tbl_companies_services_reminders")
 * @ORM\Entity
 */
class TblCompaniesServicesReminders
{
    /**
     * @var int
     *
     * @ORM\Column(name="tbl_companies_services_reminders_id", type="integer", nullable=false)
     * @ORM\Id
