...
/**
 * TblSystemFormsFields
 *
 * @ORM\Table(name="tbl_system_forms_fields")
 * @ORM\Entity
 */
class TblSystemFormsFields
{
    /**
     * @var int
     *
     * @ORM\Column(name="tbl_system_forms_fields_id", type="integer", nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $tblSystemFormsFieldsId;
    ...
    public function getTblSystemFormsFieldsId(): ?int
    {
        return $this->tblSystemFormsFieldsId;
    }
