...
/**
 * TblCompaniesFormsFields
 *
 * @ORM\Table(name="tbl_companies_forms_fields")
 * @ORM\Entity
 */
class TblCompaniesFormsFields
{
    /**
     * @var int
     *
     * @ORM\Column(name="tbl_companies_forms_fields_id", type="integer", nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $tblCompaniesFormsFieldsId;
     ...
     * @var string|null
     *
     * @ORM\Column(name="field_type", type="string", length=200, nullable=true)
     */
    private $fieldType;
    ...
    public function getTblCompaniesFormsFieldsId(): ?int
    {
        return $this->tblCompaniesFormsFieldsId;
    }
