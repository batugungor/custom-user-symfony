window.addEventListener('load', function () {
    ...
    var canvas = document.getElementById('sketchpad-0');
    ...
    var drawer = {
        ...
        touchend: function (coors) {
            if (this.isDrawing) {
                ...
                document.getElementById('apply_signature-0').value = document.getElementById('sketchpad-0').toDataURL();
            }
        }
    };
    ...
    const clear = document.getElementById('clear-0');
